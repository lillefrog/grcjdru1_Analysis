...
if sum(validTrials)<10
    warning('not enough trials in file');
end
...
%  SaccOnC{i} = SaccOnDataC.nrSpikes;   %#ok<AGROW>
 ...
 SaccOnA{i} = SaccOnDataA.meanSpikeRate;   %#ok<AGROW>
 SaccOnB{i} = SaccOnDataB.meanSpikeRate;   %#ok<AGROW>
 SaccOnC{i} = SaccOnDataC.meanSpikeRate;   %#ok<AGROW>
end

resultData.SaccOnA = SaccOnA;
resultData.SaccOnB = SaccOnB;
resultData.SaccOnC = SaccOnC;
